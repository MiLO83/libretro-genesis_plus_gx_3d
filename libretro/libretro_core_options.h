...
struct retro_core_option_definition option_defs_us[] = {
        {
                "genesis_plus_gx_3d_foreground_parallax_offset",
                "Foreground 3D Parallax Separation (Plane A)",
                "",
                {
                        { "-9",          NULL },
                        { "-8",          NULL },
        ...
        {
                "genesis_plus_gx_3d_background_parallax_offset",
                "Background 3D Parallax Separation (Plane B)",
                "",
                {
                        { "-9",          NULL },
                        { "-8",          NULL },
